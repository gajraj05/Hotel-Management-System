...
SECRET_KEY = 'django-insecure-c^^n%t_+_!!7bl_@7lmpb%1yg(6rr07)y%^ow5tc5x)0)j3#n)'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'Rathore@123',             # MySQL password
...
AUTH_USER_MODEL = "user.User_Profile"   # replace `user` with your app name